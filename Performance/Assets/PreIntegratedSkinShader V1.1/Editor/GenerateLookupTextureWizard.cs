...
// Based on code published in Gamasutra by Jon Moore
...
class GenerateLookupTextureWizard : ScriptableWizard {
    ...
    [MenuItem ("GameObject/Pre-Integrated Skin Shader/Generate Lookup Texture - diffuse and spec")]
    ...
    void OnWizardCreate () {
		string path = Application.dataPath + "/PreIntegratedSkinShader V1.1/skin_lookup_diffspec.png";
		string pathRel = "Assets/PreIntegratedSkinShader V1.1/skin_lookup_diffspec.png";
