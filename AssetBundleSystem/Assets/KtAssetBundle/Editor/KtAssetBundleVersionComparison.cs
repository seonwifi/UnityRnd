...
public class KtAssetBundleVersionComparison : EditorWindow
{
    private List<string> currentContentList;
    private string currentBundleName;
    private string exportPath;
    private float sizeInKiloBytes = 0;
	public KtAssetBundleWindow m_assetBundleWindow = null;
    ...
    //Get the window
    public static KtAssetBundleVersionComparison CreateContentWindow()
    {
        KtAssetBundleVersionComparison thisWindow = (KtAssetBundleVersionComparison)EditorWindow.GetWindow<KtAssetBundleVersionComparison>("Bundle VersionComparison",true,typeof(KtAssetBundleVersionComparison));
        return thisWindow;
    }
}
