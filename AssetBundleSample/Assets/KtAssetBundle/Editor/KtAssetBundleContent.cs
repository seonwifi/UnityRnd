...
public class KtAssetBundleContent : EditorWindow
{
    ...
    //Get the window
    public static KtAssetBundleContent CreateContentWindow()
    {
        KtAssetBundleContent thisWindow = (KtAssetBundleContent)EditorWindow.GetWindow<KtAssetBundleContent>("Bundle Contents",true,typeof(KtAssetBundleWindow));
        return thisWindow;
    }
}
