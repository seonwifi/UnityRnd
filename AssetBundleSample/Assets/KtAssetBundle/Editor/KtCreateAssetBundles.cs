...
public class KtCreateAssetBundles
{
    ...
    public static List<Object> BuildAssetBundleFromFolder(KtAssetBundleWindow thisWindow, string rootFolder, string ext, System.Type type, string bundlePath, 
														  bool isPreTest)
    {
		...
		{   
			string []paths = file.Split(new char[]{'/', '\\'});
			...
			{
				Debug.LogError("AssetBundle MakeTypeError: " + file + "	Type: " + type.ToString());
			}
		}
		if(isPreTest)
		{
	...
	public static bool BuildAssetBundleSceneFromFolder(KtAssetBundleWindow thisWindow, string rootFolder, string ext, string bundlePath, 
														  bool isPreTest)
    { 
